$(function () {
    ...
    $("#ksearch").click(function () {
        ...
        $.get("https://www.instagram.com/explore/tags/" + search + "/?__a=1", function (data, status) {
            console.log(status);
            console.log(data);

            $("#location").text(data.graphql.hashtag.name);
            $("#location1").text(data.graphql.hashtag.slug);
            $("#location2").text(data.graphql.hashtag.edge_hashtag_to_media.count);
